...
//        NSLog(@"userData: %@",cluster.marker.userData);
//        NSLog(@"cluster2: %@",marker.userData);
...
- (UIImage*)generateClusterIconWithCount:(NSUInteger)count {
    ...
    if (count > 100) [[UIColor colorWithRed:93.0/255.0 green:156.0/255.0 blue:236.0/255.0 alpha:1] setFill];
    else if (count > 10) [[UIColor colorWithRed:236.0/255.0 green:135.0/255.0 blue:192.0/255.0 alpha:1] setFill];
    else [[UIColor colorWithRed:160.0/255.0 green:212.0/255.0 blue:104.0/255.0 alpha:1] setFill];
    ...
    UIColor *fontColor;
    if ((count <= 100) && count > 10) fontColor = [UIColor whiteColor];
